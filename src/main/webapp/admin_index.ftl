                ...
                <div class="index-content-right">
                    ...
                    <div class="book-list" id="book-list">
                        <div style="position: relative">
                            <img src="/image/ams.png" style="position: absolute; left: 100px">
                            <h1 style="position: absolute; top: 20px; left: 100px">欢迎，欢迎，热烈欢迎！！！</h1>
                        </div>
                    </div>
...
<script type="text/html" id="book-tmp">
    ...
    <div class="book-item">
        ...
        <div class="book-it">
            ...
            <div class="book">
                <button onclick="editBook('{{book.bId}}')">编辑</button>
                <button onclick="deleteBook('{{book.bId}}', this)">删除</button>
            </div>
        </div>
    </div>
    {{/if}}
...
<script>
    ...
    function loadPageData(page, classifyId) {
        ...
        Af.rest('adminSelectByPageBook.api', req, function (data) {
            var p = page || 1;
            $("#myPage").sPage({
                page: p,// 当前页码
    ...
    function find() {
        ...
        Af.rest('adminFindBookAll.api', req, function (data) {
            $('.paging').hide();
            var bookData = {
                bookList: data.bookList
            }
    ...
    function editBook(bookId) {
        location.href = "/admin/book/add?bookId="+bookId;
    }

    function deleteBook(bookId, e) {
        var req = {};
        req.bookId = bookId;
        Af.rest('adminBookDelete.api', req, function (data) {
            alert('删除成功');
