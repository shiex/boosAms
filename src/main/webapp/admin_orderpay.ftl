...
<div class="index">
    <div class="cont">
        <div style="padding: 15px">
            <label>
                <h4 style="display: inline-block">订单号：</h4><label>${order.oId?c}</label>
            </label>
        ...
        <div class="index-con">
                ...
                <div class="index-con-bottom">
                    <div class="btn">
                        ...
                        <button style="background-color: #009688" onclick="fahuo(${order.oId})">发货</button><br>
                        <button style="background-color: #444444" onclick="callPay(${order.oId})">取消</button><br>
                    </div>
                </div>
        </div>
    </div>
...
<script>
    function fahuo(orderId) {
        var req = {};
        req.orderId = orderId;
        Af.rest('adminFaHuo.api', req, function (data) {
            alert('已发货');
        })
    }
